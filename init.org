...
#+BEGIN_SRC emacs-lisp
(setopt ansi-color-faces-vector
...
- =eglot= is an LSP client Emacs core since 29.1, but only supports a single server. [2025-11-28 Fri]
