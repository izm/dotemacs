...
(keymap-global-set "<remap> <scroll-up-command>" #'pixel-scroll-interpolate-up)
(keymap-global-set "<remap> <scroll-down-command>" #'pixel-scroll-interpolate-down)
